...
public class TestIfMinMax {
    ...
    @Test
    @IR(phase = { CompilePhase.PHASEIDEALLOOP_ITERATIONS }, failOn = { IRNode.IF }, counts = { IRNode.MIN_L, "1" })
    ...
    @Test
    @IR(phase = { CompilePhase.PHASEIDEALLOOP_ITERATIONS }, failOn = { IRNode.IF }, counts = { IRNode.MAX_L, "1" })
