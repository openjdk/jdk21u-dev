...
public class Resources_de extends java.util.ListResourceBundle {
    ...
    private static final Object[][] contents = {
        ...
        {"manifest.missing.when.reading.jarfile",
                "Manifest fehlt beim Lesen \u00FCber JarFile"},
        {"manifest.missing.when.reading.jarinputstream",
                "Manifest fehlt beim Lesen \u00FCber JarInputStream"},
        {"manifest.attribute.1.present.when.reading.jarfile.but.missing.via.jarinputstream",
                "Manifesthauptattribut %s ist beim Lesen \u00FCber JarFile vorhanden, aber fehlt beim Lesen \u00FCber JarInputStream"},
        {"manifest.attribute.1.present.when.reading.jarinputstream.but.missing.via.jarfile",
                "Manifesthauptattribut %s ist beim Lesen \u00FCber JarInputStream vorhanden, aber fehlt beim Lesen \u00FCber JarFile"},
        {"manifest.attribute.1.differs.jarfile.value.2.jarinputstream.value.3",
                "Manifesthauptattribut %1$s unterschiedlich: JarFile-Wert = %2$s, JarInputStream-Wert = %3$s"},
        {"entry.1.present.when.reading.jarinputstream.but.missing.via.jarfile",
                "Eintrag %s ist beim Lesen \u00FCber JarInputStream vorhanden, aber fehlt beim Lesen \u00FCber JarFile"},
        {"entry.1.present.when.reading.jarfile.but.missing.via.jarinputstream",
                "Eintrag %s ist beim Lesen \u00FCber JarFile vorhanden, aber fehlt beim Lesen \u00FCber JarInputStream"},
        {"entry.1.present.in.jarfile.but.unreadable",
                "Eintrag %s ist in JarFile vorhanden, aber nicht lesbar"},
        {"codesigners.different.for.entry.1.when.reading.jarfile.and.jarinputstream",
                "Codesignaturgeber f\u00FCr Eintrag %s beim Lesen \u00FCber JarFile anders als bei JarInputStream"},
        {"entry.1.is.signed.in.jarfile.but.is.not.signed.in.jarinputstream",
                "Eintrag %s ist in JarFile, aber nicht in JarInputStream signiert"},
        {"entry.1.is.signed.in.jarinputstream.but.is.not.signed.in.jarfile",
                "Eintrag %s ist in JarInputStream, aber nicht in JarFile signiert"},
        {"jar.contains.internal.inconsistencies.result.in.different.contents.via.jarfile.and.jarinputstream",
                "Diese JAR-Datei enth\u00E4lt interne Inkonsistenzen, die zu anderem Inhalt beim Lesen \u00FCber JarFile als beim Lesen \u00FCber JarInputStream f\u00FChren k\u00F6nnen:"},
        {"signature.verification.failed.on.entry.1.when.reading.via.jarinputstream",
                "Signaturverifizierung war f\u00FCr Eintrag %s beim Lesen \u00FCber JarInputStream nicht erfolgreich"},
        {"signature.verification.failed.on.entry.1.when.reading.via.jarfile",
                "Signaturverifizierung war f\u00FCr Eintrag %s beim Lesen \u00FCber JarFile nicht erfolgreich"},
    };
